...
import { ListFilterIcon, PanelRightOpenIcon, SearchIcon, XIcon } from "lucide-react";
...
export function SystemDataTable({ data: initialData }: { data: Row[] }) {
  "use no memo";
      ...
      <Sheet open={copilotOpen} onOpenChange={setCopilotOpen}>
        <SheetContent side="right" className="w-[25%] sm:max-w-none">
          <SheetHeader>
            ...
            <SheetDescription>AI-powered assistant for System analysis.</SheetDescription>
          </SheetHeader>
        </SheetContent>
      </Sheet>
