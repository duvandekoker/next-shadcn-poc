    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button size="icon" variant="ghost">
          <Settings2 strokeWidth={2.35} />
        </Button>
      </PopoverTrigger>
      <PopoverContent align="end">
        <div className="flex flex-col gap-5">
          <div className="space-y-1.5">
            <h4 className="font-medium text-base leading-none">Preferences</h4>
            <p className="text-muted-foreground text-sm">Customize your dashboard layout preferences.</p>
          </div>
