        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <Link
              ...
              className={cn("flex items-center pt-1 pb-3", isCollapsed ? "justify-center" : "gap-2")}
            >
              <svg
