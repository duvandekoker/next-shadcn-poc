...
export const sampleContent: NodeJSON = {
  ...
  content: [
    ...
    },
    {
      ...
      content: [{ type: "paragraph", content: [{ type: "text", text: "Bullet points that guide thoughts" }] }],
    },
    {
      type: "list",
      attrs: { kind: "bullet", order: null, checked: false, collapsed: false },
      content: [
        { type: "paragraph", content: [{ type: "text", text: "Nested lists for complex ideas" }] },
        {
          type: "list",
          attrs: { kind: "bullet", order: null, checked: false, collapsed: false },
          content: [{ type: "paragraph", content: [{ type: "text", text: "Sub-points flow naturally" }] }],
        },
      ],
    },
    {
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              type: "tableCell",
              attrs: {},
              content: [{ type: "paragraph", content: [{ type: "text", text: "Select and choose" }] }],
            },
            {
              type: "tableCell",
              attrs: {},
              content: [{ type: "paragraph", content: [{ type: "text", text: "Perfect styling" }] }],
            },
          ],
        },
        {
          ...
          content: [
            ...
            },
            {
              type: "tableCell",
              attrs: {},
              content: [{ type: "paragraph", content: [{ type: "text", text: "Type @ and name" }] }],
            },
            {
              type: "tableCell",
              attrs: {},
              content: [{ type: "paragraph", content: [{ type: "text", text: "Connected ideas" }] }],
            },
          ],
        },
        {
          ...
          content: [
            {
              type: "tableCell",
              attrs: {},
              content: [{ type: "paragraph", content: [{ type: "text", text: "Insert anything" }] }],
            },
            {
              type: "tableCell",
              attrs: {},
              content: [{ type: "paragraph", content: [{ type: "text", text: "Press / for menu" }] }],
            },
            {
              type: "tableCell",
              attrs: {},
              content: [{ type: "paragraph", content: [{ type: "text", text: "Endless possibilities" }] }],
            },
          ],
        },
      ],
